...
$deleteForm.addEventListener('submit', (e) => {
    ...
    const $emailLabel = $deleteForm['email'].closest('[data-aeo-object="label"]');
    const $agreeLabel = $deleteForm['agreeRemoveAccount'].closest('[data-aeo-object="label"]');
    ...
    if (!$deleteForm['emailCodeSendButton'].hasAttribute('disabled') || !$deleteForm['emailCodeVerifyButton'].hasAttribute('disabled')) {
